        ...
        <div class="filters">
          ...
          <form method="POST">
            ...
            <p class="filtersLine">
              ...
              <?php
                require("conn.php");
                $result = $conn->query("SELECT * FROM produkty, parametry WHERE (produkty.model = parametry.model) AND (kategoria  = 'laptopy') GROUP BY procesor");
            ...
            <p class="filtersLine">
              ...
              <?php
                require("conn.php");
                $result = $conn->query("SELECT * FROM produkty, parametry WHERE (produkty.model = parametry.model) AND (kategoria  = 'laptopy') GROUP BY sysop");
          ...
          <div class="products">
            ...
            <div class="productBox">
              <?php
                ...
                $sql = "SELECT * FROM produkty, parametry WHERE (produkty.model = parametry.model) AND (kategoria  = 'laptopy') ";
