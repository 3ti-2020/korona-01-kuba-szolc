      ...
      <div class="main">
        <div class="filters">
          ...
          <form method="POST">
            ...
            <p class="filtersLine">
              Ekran:
              <input type="text" name="minEkran" placeholder="od">
              <input type="text" name="maxEkran" placeholder="do">
            </p>
            ...
            <p class="filtersLine">
              ...
              <?php
                require("conn.php");
                $result = $conn->query("SELECT * FROM produkty, parametry WHERE (produkty.model = parametry.model) AND (kategoria  = 'smartfony') GROUP BY procesor");
            ...
            <p class="filtersLine">
              ...
              <?php
                require("conn.php");
                $result = $conn->query("SELECT * FROM produkty, parametry WHERE (produkty.model = parametry.model) AND (kategoria  = 'smartfony') GROUP BY sysop");
          ...
          <div class="products">
            ...
            <div class="productBox">
              <?php
                ...
                $sql = "SELECT * FROM produkty, parametry WHERE (produkty.model = parametry.model) AND (kategoria  = 'Smartfony') ";
